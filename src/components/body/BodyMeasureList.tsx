...
// Mess-Liste: je Messung Datum + Chips der vorhandenen Werte, neueste zuerst.
// Oben ein Knopf zum Hinzufuegen, je Zeile Bearbeiten und Loeschen. Anlegen und
// Bearbeiten laufen ueber das gemeinsame Mess-Popup; Loeschen ist zweistufig
// (kurze Rueckfrage in der Zeile), weil es sofort greift. Ohne Messung nur der
// Hinzufuegen-Knopf plus ein kurzer Hinweis.
